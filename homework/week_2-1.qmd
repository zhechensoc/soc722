---
title: "SOC722 Exercise Week 2-1"
author: "Zhe Chen"
date: "2026-01-18"
...
Quarto allows for [easy cross-references of images and plots](https://quarto.org/docs/authoring/cross-references.html#figures). @fig-chapel shows an image, whereas @fig-plot shows a plot created using ggplot2.

![A photo of Duke Chapel. Copyright: Zhe Chen](images/chapel.png){#fig-chapel fig-align="center"}
...
It's also easy to cross-reference equations. For example, @eq-1 depicts the *probability density function of normal distribution.*
...
> Hi! My name is Zhe. One of my favorite academic books is @bourdieu1980. @correll2026 is the last thing I read. The next thing I plan on reading is Rawlings et al.'s *Network Analysis: Integrating Social Network Theory, Method, and Appplication with R* [-@rawlings2023] book.
