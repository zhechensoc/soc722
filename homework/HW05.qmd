...
```{r}
pre_guess <- 1 - (1 - pre)*(31/30)
pre_guess
```

My best guess for the true value of PRE is 0.828.
...
My best guess for the true value of PRE is 0.991.
...
```{r}
pre_guess <- 1 - (1 - pre)*(10/9)
pre_guess
```

My best guess the true value of PRE is 0.501.
...
```{r}
pre_guess <- 1 - (1 - pre)*(3163/3162)
pre_guess
```

The best estimate for the true value of PRE is 0.050.
